...
DEFAULT_OWNER_WHATSAPP = os.getenv("SAHBUKTI_DEFAULT_OWNER_WHATSAPP", "60123456789")
...
def _read_vault_secret(*labels: str) -> str:
    ...
    for line in content.splitlines():
        for label in labels:
            if label in line:
                return line.split(label, 1)[1].split("|", 1)[0].strip()
    return ""
...
WHATSAPP_API_KEY = os.getenv("SAHBUKTI_WHATSAPP_API_KEY") or _read_vault_secret("WAHA key:")
